...
sub gen_discrim
{
    s|(</discrim>)(<discrim )|\U\1\E<z>, </z>\U$2\E|g;
}
...
sub gen_discrim_g
{
    s|(</tgr>)(<discrim-g )|$1<z>;</z>$2 |g; 
    s|<(discrim-g) ([^>]*)>| <\U\1\E $2><z>\(</z>|g;
    s|</(discrim-g)>|<z>\)</z></\U\1\E>|g;
}
...
sub gen_dr_g
{
    ...
    if ($DRSYM_NEWLINE)
    {
        s|<dr-g ([^>]*)>|<DR-G zp=\"y\" $1><z>&drsym; </z>|g;
    }
    else
    {
...
#    {
#	s|<zp_dr-g/><DR-G ([^>]*)>|<zp_dr-g/><DR-G $1><z>&drsym; </z>|g; # mantis 2736 ...
#    }
    if ($DRSYM_RUNON_ALWAYS)
    {
	s|</DR-G> <DR-G ([^>]*)>|</DR-G> <DR-G $1><z>&drsym; </z>|g;
    }
...
sub gen_trans_g
{
    my($e, $sep) = @_;
    my($res, $eid);
    $e =~ s|(</trans-g>) *(<trans-g)|\U\1\E$sep\U\2\E|;
    return $e;
}
