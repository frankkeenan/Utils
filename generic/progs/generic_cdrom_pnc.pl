...
# Input =
# Result =
# $Id: generic_cdrom_pnc.pl,v 1.2 2011/12/16 10:27:34 keenanf Exp $
# $Log: generic_cdrom_pnc.pl,v $
# Revision 1.2  2011/12/16 10:27:34  keenanf
# *** empty log message ***
#
# Revision 1.1  2011/06/22 11:15:10  keenanf
# Initial revision
#
...
sub gen_eltdicts_xml_symbols
{
    s|</z><z>||g;
#   map eltdicts symbols as per project symbol fonts ...
    s|&(awlsym);|<img src=\"\1.png\"/>|gi;
    s|&(csym);|<img src=\"\1.png\"/>|gi;
    s|&(cfesym);|<img src=\"\1.png\"/>|gi;
    s|&(cfesep);|<img src=\"\1.png\"/>|gi;
    s|&(clsym);|<img src=\"\1.png\"/>|gi;
    s|&(coresym);|<img src=\"\1.png\"/>|gi;
    s|&(crosssym);|<img src=\"\1.png\"/>|gi;
    s|&(drsym);|<img src=\"\1.png\"/>|gi;
    s|&(etymsym);|<img src=\"\1.png\"/>|gi;
    s|&(helpsym);|<img src=\"\1.png\"/>|gi;
    s|&(idsym);|<img src=\"\1.png\"/>|gi;
    s|&(idssym);|<img src=\"\1.png\"/>|gi;
    s|&(idsyms);|<img src=\"\1.png\"/>|gi;
    s|&(idsep);|<img src=\"\1.png\"/>|gi;
    s|&(notesym);|<img src=\"\1.png\"/>|gi;
    s|&(oppsym);|<img src=\"\1.png\"/>|gi;
    s|&(psym);|<img src=\"\1.png\"/>|gi;
    s|&(pvarr);|<img src=\"\1.png\"/>|gi;
    s|&(pvsym);|<img src=\"\1.png\"/>|gi;
    s|&(pvsyms);|<img src=\"\1.png\"/>|gi;
    s|&(pvsep);|<img src=\"\1.png\"/>|gi;
    s|&(reflsym);|<img src=\"\1.png\"/>|gi;
    s|&(sdsym);|<img src=\"\1.png\"/>|gi;
    s|&(synsep);|<img src=\"\1.png\"/>|gi;
    s|&(taboo);|<img src=\"\1.png\"/>|gi;
    s|&(tceqsym);|<img src=\"\1.png\"/>|gi;
    s|&(tusipa);|<img src=\"\1.png\"/>|gi;
    s|&(tssym);|<img src=\"\1.png\"/>|gi;
    s|&(unsym);|<img src=\"\1.png\"/>|gi;
    s|&(xrsym);|<img src=\"\1.png\"/>|gi;
    s|&(xsep);|<img src=\"\1.png\"/>|gi;
    s|&(xsymfirst);|<img src=\"\1.png\"/>|gi;
}
