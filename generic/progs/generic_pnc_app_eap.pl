...
#   insert expansion text ...
	...
	s|<alt ([^>]*)q="(.*?)"(.*?)>|<alt $1Q="$2"$3><z_a>$text </z_a>|;
    }
...
sub gen_dhs
{
    s|</dhs>|</DHS><z>&\#x2019;</z>|g;
    s| ?<dhs | <z>&\#x2018;</z><DHS |g;
}
...
sub gen_i
{
    ...
    s|</i><g ([^<]*)</g><i |</I><z>; </z><G $1</G> <I |g;
    s|</i> *<g ([^<]*)</g><y |</I><z>; </z><G $1</G> <Y |g; # mantis 2530 ...
    s|</y><g ([^<]*)</g><i |</Y><z>; </z><G $1</G> <I |g; # mantis 2585 ...
...
sub gen_id
{
    ...
    s|</id>(<g ([^>]*)></g>)<id |</ID><z>$ID_SEP</z>$1 <ID |g; # mantis 2303 ...
    s|</id>(<r ([^>]*)></r>)<id |</ID><z>$ID_SEP</z>$1 <ID |g; # mantis 2303 ...
    s|</id>(<s ([^>]*)></s>)<id |</ID><z>$ID_SEP</z>$1 <ID |g; # mantis 2303 ...
}
...
#    s|</pv-g></pvp-g><pvp-g([^>]*)><pv-g |</PV-G></PVP-G><zp_pv-g/><PVP-G$1><PV-G |g; # mantis 2522 ...
    ...
    s|<pv-g ([^>]*>)|<PV-G $1&pvsym; |g;
#    s|</sd-g><z> &pvsym|</sd-g><z>&pvsym|g;
    if ($PVSEP)
    {
	s|</pv-g> <pv-g |</pv-g><z> &pvsep; </z><pv-g |gi;
    }
}
...
{
    s|</sym>|</SYM><z>\)</z>|g;
    s|<sym |<z> \(</z><z_sym>&z_symb;</z_sym> <SYM |g;
}
...
#   add missing spaces ...
    ...
    s|\.<xr |. <xr |gi;
    s|<z>\)\)|<z>\)|g;
    s|&&\#x2014; <cl>|&&\#x2014;<cl>|g;
    s|([\.\!\?])<gl|$1 <gl|g;
    s|&\#x2018; <cl>|&\#x2018;<cl>|g;
    s|</gl> &\#x2019;</x>|</gl>&\#x2019;</x>|g;
    s|</cl> &&\#x2014;|</cl>&&\#x2014;|g;
...
{
    s|&(awlsym);|<img src=\"\1\"/>|gio;
    s|&(cfesep);|<img src=\"\1\"/>|gio;
    s|&(cfesym);|<img src=\"\1\"/>|gio;
    s|&(clsym);|<img src=\"\1\"/>|gio;
    s|&(coresym);|<img src=\"\1\"/>|gio;
    s|&(crosssym);|<img src=\"\1\"/>|gio;
    s|&(csym);|<img src=\"\1\"/>|gio;
    s|&(drsym);|<img src=\"\1\"/>|gio;
    s|&(etymsym);|<img src=\"\1\"/>|gio;
    s|&(helpsym);|<img src=\"\1\"/>|gio;
    s|&(idsep);|<img src=\"\1\"/>|gio;
    s|&(idsym);|<img src=\"\1\"/>|gio;
    s|&(idsyms);|<img src=\"\1\"/>|gio;
    s|&(notesym);|<img src=\"\1\"/>|gio;
    s|&(oppsym);|<img src=\"\1\"/>|gio;
    s|&(p_in_(.*?));|<img src=\"\1\"/>|gio;
    s|&(psym);|<img src=\"\1\"/>|gio;
    s|&(pvarr);|<img src=\"\1\"/>|gio;
    s|&(pvsep);|<img src=\"\1\"/>|gio;
    s|&(pvsym);|<img src=\"\1\"/>|gio;
    s|&(pvsyms);|<img src=\"\1\"/>|gio;
    s|&(reflsym);|<img src=\"\1\"/>|gio;
    s|&(s_in_(.*?));|<img src=\"\1\"/>|gio;
    s|&(sdsym);|<img src=\"\1\"/>|gio;
    s|&(synsep);|<img src=\"\1\"/>|gio;
    s|&(synsep2);|<img src=\"\1\"/>|gio;
    s|&(synsym);|<img src=\"\1\"/>|gio;
    s|&(taboo);|<img src=\"\1\"/>|gio;
    s|&(tceqsym);|<img src=\"\1\"/>|gio;
    s|&(ticksym);|<img src=\"\1\"/>|gio;
    s|&(tssym);|<img src=\"\1\"/>|gio;
    s|&(tusipa);|t&\#x032C;|gio; # flap t as proper unicode - for typesetting redefine as &#xE000;
    s|&(unsym);|<img src=\"\1\"/>|gio;
    s|&(w_in_(.*?));|<img src=\"\1\"/>|gio;
    s|&(xrsym);|<img src=\"\1\"/>|gio;
    s|&(xsep);|<img src=\"\1\"/>|gio;
    s|&(xsym_first);|<img src=\"\1\"/>|gio;
}
