...
sub gen_cfe_gs {
    my($e) = @_;
    $e =~ s|<cfe-gs ([^>]*>)| <CFE-GS \1><z>&cfesym; </z>|g;
    return($e);
}
...
sub gen_geo {
    my($e) = @_;
    $e =~ s|</cf><geo |</CF><z>;</z><geo |g; # mantis 1941 ...
    $e =~ s|</geo><geo |</GEO><z>, </z><GEO |g;
    $e =~ s|</geo><r |</GEO><z>, </z><R |g;
    $e =~ s|</geo><s |</GEO><z>, </z><S |g;
    $e =~ s|</r><geo |</R><z>, </z><GEO |g;
    $e =~ s|<geo brackets="n"(.*?)</geo>| <GEO $1</GEO>|g; # mantis 2699
    $e =~ s|</geo>|<z>\)</z></GEO>|g;
    $e =~ s|<geo ([^>]*)>| <GEO $1><z>\(</z>|g;
    return($e);
}
...
sub gen_gram {
    ...
    $e = &add_space_between($e, "gram", "cf");
    $e =~ s|</gram><p |</gram><z>,</z><p |g;
    $e =~ s|</gram><gram |</GRAM><z>,&nbthinsp;</z><GRAM |g;
    if (0)
    {
	$e =~ s|</gram>|<z_gr_br>\]</z_gr_br></GR>|g;
	$e =~ s|<gram ([^>]*)>| <GRAM $1><z_gr_br>\[</z_gr_br>|g;
    }
    $e =~ s| *(</gram>) *(<label-g)|$1 $2|gi;
    $e =~ s| *(</gram>) *(<def-g)|$1 $2|gi;
    $e =~ s| *(</gram>) *(<sn-g)|$1 $2|gi;
    $e =~ s| *(</gram>) *(<vs-g)|$1 $2|gi;
    return($e);
}
...
sub gen_idm {
    ...
    $e =~ s|</idm><idm |</IDM><z>$IDSEP_CHAR </z><IDM |g;
    $e =~ s|(</idm>)(<label-g)|$1 $2|gi;
    return($e);
}
...
sub gen_idm_g {
    ...
    my(@BITS);
    if ($IDG_NEWLINE) {
	$e =~ s|</id-g><id-g |</ID-G><IDM-G zp=\"y\" |g;
    }
    else {
	$e =~ s|</id-g><id-g |</ID-G> &idsep; <IDM-G |g;
    }
    if (($IDSYM_ICON) || ($IDG_SYMBOL_ALL)) {
	if ($IDSYM_NEWLINE) {
	    $e =~ s|<id-g ([^>]*multi=\"y[^>]*)>|<IDM-G zp=\"y\" $1><z>&idsyms; </z>|g;
	    $e =~ s|<id-g ([^>]*)>|<IDM-G zp=\"y\" $1><z>&idsym; </z>|g;
	}
	else {
	    $e =~ s|<id-g ([^>]*multi=\"y[^>]*)>| <IDM-G $1><z>&idsyms; </z>|g;
	    $e =~ s|<id-g ([^>]*)>| <IDM-G $1><z>&idsym; </z>|g;
	}
    }
    $e = &gen_idm($e);
    if ($IDG_SEP){
...
sub gen_idm_gs {
    ...
    my($bit, $res);
    my(@BITS);
    $e =~ s|(<idm-gs[ >].*?</idm-gs>)|&split;&fk;$1&split;|gi;
    @BITS = split(/&split;/, $e);
    $res = "";
    foreach $bit (@BITS){
	if ($bit =~ s|&fk;||gi){
	    if (($IDSYMS_ICON) || ($IDG_SYMBOL_FIRST)) {
		$bit = &add_idsym_symbols($bit);
	    }    
	    $bit = &gen_idm_g($e);
	}
	$res .= $bit;
...
sub add_idsym_symbols {
    ...
    my(@BITS);
    if ($e =~ m|<idm[ >].*<idm[ >]|i) {
	$e =~ s|<idm-gs ([^>]*)>| <IDM-GS $1>&idsyms; |i;
    }
    else {
	$e =~ s|<idm-gs ([^>]*)>| <IDM-GS $1>&idsym; |i;
    }
    return $e;
}
...
sub gen_if {
    ...
    $e =~ s|</if><geo |</IF><z>, </z><G |g; # mantis 1788 ...
...
sub gen_if_g {
    my($e) = @_;
    $e =~ s|(</if-g><if-g ([^>]*)>)<geo |$1<G |g; # mantis 2561 ...
...
sub gen_opp {
    my($e) = @_;
    $e =~ s|</geo><opp |</geo> <OPP |g;
    $e =~ s|</r><opp |</r> <OPP |g;
    $e =~ s|</opp><opp |</OPP><z>, </z><OPP |g;
    $e =~ s|</opp><geo |</OPP><z>,</z><geo |g;
...
sub gen_phon_gb {
    my($e) = @_;
    $e =~ s|</phon-gb><geo ([^<]*)</geo><phon-gb |</PHON-GB><z>; </z><G $1</GEO> <PHON-GB |g;
...
sub gen_v {
    ...
    $e =~ s|</r><v |</R> <V |g;
    $e =~ s|</s><v |</S> <V |g;
    $e =~ s|</v><geo |</V><z>, </z><G |g; # mantis 1779 ...
...
sub gen_y {
    my($e) = @_;
    $e =~ s|</y><y |</Y><z>; </z><Y |g;
    $e =~ s|</y><geo ([^<]*)</geo><i |</Y><z>; </z><G $1</GEO> <I |g;
    $e =~ s|</y><geo ([^<]*)</geo><y |</Y><z>; </z><G $1</GEO> <Y |g;
    unless ($US_IPA_FIRST) {
...
#   tidy up line starts ...
    ...
    $e =~ s|</geo><eb>|</geo> <eb>|gi; # mantis 2699 ...
...
sub gen_label_punc {
	...
	if ($bit =~ s|&fk;||gio){
	    ...
	    $bit =~ s|(<label-g[^>]*>)(<gram [^>]*>[^<]*</gram>)(</label-g>)|$1\[$2\]$3|gi;
	    $bit =~ s|(<label-g[^>]*>)(<geo [^>]*>[^<]*</geo>)(</label-g>)|$1\($2\) $3|gi;
	    ...
	    $bit =~ s|(<label-g[^>]*>)(<[grsu] [^>]*>[^<]*</[grsu]>)(<gram [^>]*>[^<]*</gram>)(</label-g>)|$1\($2\) \[$3\] $4|gi;
	    $bit =~ s|(<label-g[^>]*>)(<gram [^>]*>[^<]*</gram>)(<[grsu] [^>]*>[^<]*</[rgsu]>)(</label-g>)|$1\[$2\] \($3\) $4|gi;
	    $bit =~ s|(<label-g[^>]*>)(<pt [^>]*>[^<]*</pt>)(<[grsu] [^>]*>[^<]*</[grsu]>)(<geo [^>]*>[^<]*</geo>)(</label-g>)|$1\[$2\] \($3\) \($4\) $5|gi;
	    $bit =~ s|(<label-g[^>]*>)(<gram [^>]*>[^<]*</gram>)(<[grsu] [^>]*>[^<]*</[rgsu]>)(<[grsu] [^>]*>[^<]*</[rgsu]>)(</label-g>)|$1\[$2\] \($3 $4\) $5|gi;
	    $bit =~ s|(<label-g[^>]*>)(<pt [^>]*>[^<]*</pt>)(<[grsu] [^>]*>[^<]*</[rgsu]>)(<[grsu] [^>]*>[^<]*</[rgsu]>)(</label-g>)|$1\[$2\] \($3\) \($4\) $5|gi;
	    $bit =~ s|(<label-g[^>]*>)(<r [^>]*>[^<]*</r>)(<geo [^>]*>[^<]*</geo>)(<r [^>]*>[^<]*</r>)(</label-g>)|$1\($2\) \($3 $4\) $5|gi;
	    $bit =~ s|(<label-g[^>]*>)(<[grsu] [^>]*>[^<]*</[rgsu]>) *(<cm [^>]*>[^<]*</cm>) *(</label-g>)|$1\($2\) $3 $4|gi;
	    $bit =~ s|(<label-g[^>]*>)(<gram [^>]*>[^<]*</gram>) *(<cm [^>]*>[^<]*</cm>) *(</label-g>)|$1\[$2\] $3 $4|gi;
	    if ($dict =~ m|ald8|i) {
	    ...
	    $bit =~ s|(<label-g[^>]*>)(<gram [^>]*>[^<]*</gram>)(<[grsu] [^>]*>[^<]*</[rgsu]>)(<[grsu] [^>]*>[^<]*</[rgsu]>)(</label-g>)|$1\[$2\] \($3\) \($4\) $5|gi;
#(<g>US</geo>) <cm>or</cm> (<r>old-fashioned</r>)
#<r>old-fashioned</r><g>Brit</geo><r>informal</r>
#(<r>old-fashioned</r>) (<g>Brit</geo> <r>informal</r>)
	    if ($bit =~ m| brackets=\"n\"|) {
		$bit = $start;
	    }
